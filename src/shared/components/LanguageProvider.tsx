...
const translations = {
  en: {
    ...
    otherAge: 'Other age?',
    minimumDrivingExperience: 'Minimum driving experience',
    mileageLimit: 'Mileage limit',
    no: 'No',
    insurance: 'Insurance',
    fullCoveragePlus: 'Full Coverage Plus',
    weRecommend: 'WE RECOMMEND',
    aDay: 'a day',
    fullDamageCoverage: 'Full damage coverage',
    noDriverLiability: 'No driver liability for accident-related damage',
    fullCoverage: 'Full Coverage',
    fullCoverageLimited: 'Full coverage with limited driver liability (SuperCDW)',
    coverageForCollision: 'Coverage for collision damage caused to other vehicles (TPL)',
    basicCoverage: 'Basic coverage',
    limitedCollisionCoverage: 'Limited collision coverage (CDW)',
    glassAndWheelDamage: 'Glass and wheel damage coverage',
    minimumCoverage: 'Minimum coverage',
    freeOfCharge: 'Free of charge',
    collisionDamageCoverage: 'Collision damage coverage',
    cost: 'Cost',
    rentForDays: 'Rent for 14 days',
    delivery: 'Delivery',
    atPickup: 'At pick-up',
    atDropoff: 'At drop-off',
    other: 'Other',
    minimumCoverageTpl: 'Minimum coverage (TPL)',
    total: 'Total',
    toPayNow: 'To pay now on the website',
    toPayWhenPickingUp: 'To pay when picking up the car',
    continue: 'Continue',
    previous: 'Previous',
    bookingStepPlaceholder: 'Booking step coming soon...',
    paymentStepPlaceholder: 'Payment step coming soon...',
    pickupPlace: 'Pick-up place',
    dropoffPlace: 'Drop-off place',
    flightNumber: 'Flight number',
    mainDriversDetails: 'Main driver\'s details',
    fullNameLatin: 'Full name in Latin characters without accents *',
    dateOfBirth: 'Date of birth *',
    email: 'Email *',
    contactPhoneNumber: 'Contact phone number *',
    specifyInstantMessengers: 'Please specify instant messengers on this phone number. We will try to use them first to contact you',
    telegram: 'Telegram',
    whatsapp: 'WhatsApp',
    viber: 'Viber',
  ...
  al: {
    ...
    // Booking
    stepCar: 'Makina',
    stepBooking: 'Rezervimi',
    stepPayment: 'Pagesa',
    noDeposit: 'Pa depozitë',
    specifications: 'Specifikimet',
    gearBox: 'Kutia e shpejtësive',
    engine: 'Motori',
    yearOfManufacture: 'Viti i prodhimit',
    audio: 'Audio',
    allSpecifications: 'TË GJITHA SPECIFIKIMET',
    requirements: 'Kërkesat',
    driversAge: 'Mosha e shoferit',
    otherAge: 'Mosha tjetër?',
    minimumDrivingExperience: 'Përvojë minimale e vozitjes',
    mileageLimit: 'Kufiri i kilometrazhës',
    no: 'Jo',
    insurance: 'Sigurimi',
    fullCoveragePlus: 'Mbulim i Plotë Plus',
    weRecommend: 'REKOMANDOJmë',
    aDay: 'në ditë',
    fullDamageCoverage: 'Mbulim i plotë i dëmit',
    noDriverLiability: 'Pa përgjegjësi shoferi për dëmin e aksidentit',
    fullCoverage: 'Mbulim i Plotë',
    fullCoverageLimited: 'Mbulim i plotë me përgjegjësi të kufizuar shoferi (SuperCDW)',
    coverageForCollision: 'Mbulim për dëm në përplasje të shkaktuar në automjete të tjera (TPL)',
    basicCoverage: 'Mbulim bazë',
    limitedCollisionCoverage: 'Mbulim i kufizuar i përplasjes (CDW)',
    glassAndWheelDamage: 'Mbulim për dëm në xham dhe rrota',
    minimumCoverage: 'Mbulim minimal',
    freeOfCharge: 'Falas',
    collisionDamageCoverage: 'Mbulim për dëm në përplasje',
    cost: 'Kostoja',
    rentForDays: 'Qira për 14 ditë',
    delivery: 'Dorëzimi',
    atPickup: 'Në marrje',
    atDropoff: 'Në dorëzim',
    other: 'Të tjera',
    minimumCoverageTpl: 'Mbulim minimal (TPL)',
    total: 'Totali',
    toPayNow: 'Për të paguar tani në faqen e internetit',
    toPayWhenPickingUp: 'Për të paguar kur merrni makinën',
    continue: 'Vazhdo',
    previous: 'Më parë',
    bookingStepPlaceholder: 'Hapi i rezervimit vjen së shpejti...',
    paymentStepPlaceholder: 'Hapi i pagesës vjen së shpejti...',
    pickupPlace: 'Vendi i marrjes',
    dropoffPlace: 'Vendi i dorëzimit',
    flightNumber: 'Numri i fluturimit',
    mainDriversDetails: 'Detajet e shoferit kryesor',
    fullNameLatin: 'Emri i plotë',
    dateOfBirth: 'Data e lindjes *',
    email: 'Email *',
    contactPhoneNumber: 'Numri i telefonit të kontaktit *',
    specifyInstantMessengers: 'Ju lutemi specifikoni mesazherët e menjëhershëm në këtë numër telefoni. Ne do të përpiqemi t\'i përdorim së pari për t\'ju kontaktuar',
    telegram: 'Telegram',
    whatsapp: 'WhatsApp',
    viber: 'Viber',
    additionalPhoneNumber: 'Numri shtesë i telefonit',
    comment: 'Komenti',
    acceptTerms: 'Unë pranoj',
    termsOfUse: 'Kushtet e përdorimit',
    readPrivacy: 'Kam lexuar',
    privacyPolicy: 'Politikën e privatësisë',
    payByCard: 'Paguaj me kartë',
